{% macro kylin__datediff(first_date, second_date, datepart) %}
    ...
    {%- elif datepart in ('hour', 'minute', 'second', 'millisecond', 'microsecond') -%}
        ...
        case when {{first_date}} < {{second_date}}
            ...
            {% if datepart == 'microsecond' %}
                ...
                -- Kylin doesn't really support microseconds, so this is a massive hack!
    ...
    {%- else -%}
        ...
        {{ exceptions.raise_compiler_error("macro datediff not implemented for datepart ~ '" ~ datepart ~ "' ~ on Kylin") }}
